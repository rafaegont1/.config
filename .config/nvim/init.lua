...
-- Keep signcolumn on numbers column
...
-- Fill end of file with dots instead of ~
...
vim.api.nvim_set_keymap('n', '<A-w>', '<C-w>q', { silent = true })

-- Open this configuration file
vim.api.nvim_set_keymap('n', '<A-o>', ':e $HOME/.config/nvim/init.lua<CR>', { silent = true })

-- Save current file
vim.api.nvim_set_keymap('n', '<C-s>', ':w<CR>', { silent = true })

-- Toggle neovim tree
vim.api.nvim_set_keymap('n', '<A-t>', ':NvimTreeFocus<CR>', { silent = true })
